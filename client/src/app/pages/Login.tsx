    ...
    <div style={{
      ...
      <div style={{ flex: 1, display: 'flex', position: 'relative', zIndex: 1 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
          <img src="/logo-icon.png" alt="EasyFact" style={{ width: 52, height: 52, borderRadius: 16, objectFit: 'cover' }} />
          <span style={{ fontFamily: "'Syne', sans-serif", fontSize: '26px', fontWeight: '800', color: t.logoText }}>EasyFact</span>
        </div>
        ...
        <div style={{
          ...
          <div style={{ width: '100%', maxWidth: '420px' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '36px', justifyContent: 'center' }}>
              <img src="/logo-icon.png" alt="EasyFact" style={{ width: 44, height: 44, borderRadius: 14, objectFit: 'cover' }} />
              <span style={{ fontFamily: "'Syne', sans-serif", fontSize: '22px', fontWeight: '800', color: isDark ? 'white' : '#1e293b', transition: 'color 0.4s ease' }}>EasyFact</span>
            </div>
